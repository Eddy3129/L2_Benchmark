...
export const MAINNET_NETWORKS: Record<string, NetworkConfig> = {
  mainnet: {
    ...
    chainId: 1,
    rpcUrl: getRpcUrl('ETHEREUM_MAINNET_RPC_URL', 'https://eth-mainnet.g.alchemy.com/v2/demo'),
  ...
  arbitrum: {
    ...
    chainId: 42161,
    rpcUrl: getRpcUrl('ARBITRUM_MAINNET_RPC_URL', 'https://arb1.arbitrum.io/rpc'),
  ...
  base: {
    ...
    displayName: 'Base',
    chainId: 8453,
    rpcUrl: getRpcUrl('BASE_MAINNET_RPC_URL', 'https://mainnet.base.org'),
